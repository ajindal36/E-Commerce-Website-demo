...
<body style="background:url(black.jfif); background-size: cover">
<center>
<h1 style="color: white" align="center"><i>Dashboard For
Brands</i></h1>
<div style="background: white;width: 70%;border-radius: 0px; height:
60%">
<?php
...
echo "<form method=POST action=\"brand_home.php\">"; echo "<select name=genre>";
while ($rec=mysqli_fetch_assoc($rec_set))
{
echo "<option value
=".$rec['inf_genre'].">".$rec['inf_genre']."</option>";
} echo "</select>"; echo "<br>";
echo "<input id=\"but\" type=submit name=submit value=\"Find influencers in genre\">"; echo "</form>";
echo "</HTML>";
?>
<?php
...
echo "<tr>";
echo "<th scope=\"row\">$i</th>"; echo "<td> $inf_name </td>"; echo "<td> $inf_genre </td>"; echo "<td> $inf_email </td>";
